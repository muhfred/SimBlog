...
namespace BlogApp.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult New()
        {
            ...
            {
                Roles = Database.Session.Query<Role>().Select(role => new RoleCkeckbox
                {
                    Id = role.Id,
                    IsChecked = false,
                    Name = role.Name
        ...
        public ActionResult Edit(int id, UserEdit form)
        {
            ...
            if (Database.Session.Query<User>().Any(u => u.Username == form.Username && u.Id != id))
                ModelState.AddModelError("User", "Username must be unique");
        ...
        private void SyncRoles(IList<RoleCkeckbox> checkboxes, IList<Role> roles)
        {
